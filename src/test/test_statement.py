...
END
""",
        expected_signature="select_int(n int)",
        expected_returns="returns int",
        expected_schema="public",
        expected_body="LANGUAGE sql IMMUTABLE RETURNS NULL ON NULL INPUT PARALLEL safe BEGIN ATOMIC RETURN n; END",
        expected_is_proc=False,
